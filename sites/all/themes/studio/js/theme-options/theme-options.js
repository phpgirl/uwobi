...
// -------------------------------------------------------------------------------------------------------------------------------
  ...
  $(document).ready(function($) {
  	...
  	var color_style = $('#color-style').val();
  	if (color_style == 'color-dark') {
  	...
  	} else if (color_style == 'color-light') {
		...
		$('.color-light .title p, .color-light .date_blog li, .color-light .date_blog li a, .color-light .date_blog h2 a, .color-light .text_blog a, .color-light .social h3, .color-light .color-black, .color-light .social h3 span, .color-light .number p, .color-light.contact_us p, .color-light.contact_us h3 a, .color-light aside h2, .color-light aside p, .color-light .color-dark-font').addClass('color-font-black').removeClass('color-font');
  		...
  		$('.dark').removeClass('active');
		$('.litght').removeClass('active');
		$('.default').addClass('active');
  	}

  	$('.blogs .container > .row:first-child > div').addClass('single-post');
    ...
    //var base_url = $(".skin").attr('data-baseurl');
    //$(".skin").attr("href", base_url+"/css/skins/"+ skin + "/" + skin + ".css");
	...
	$('.single-post h1, .single-post h2, .single-post h3, .single-post h4, .single-post h5, .single-post h6, .single-post label').addClass('color-dark-font');
    ...
    // Color changer
    $(".red").click(function(){
	   	$(".skin").attr("href", base_url+"/css/skins/red/red.css");
	    return false;
	});
	$(".cyan").click(function(){
	    $(".skin").attr("href", base_url+"/css/skins/cyan/cyan.css");
	    return false;
	});
	$(".yellow").click(function(){
	    $(".skin").attr("href", base_url+"/css/skins/yellow/yellow.css");
	    return false;
	});
	$(".green").click(function(){
	    $(".skin").attr("href", base_url+"/css/skins/green/green.css");
	    return false;
	});
	$(".orange").click(function(){
    	$(".skin").attr("href", base_url+"/css/skins/orange/orange.css");
    	return false;
	});
	$(".bone").click(function(){
	    $(".skin").attr("href", base_url+"/css/skins/bone/bone.css");
	    return false;
	});
	$(".orange-light").click(function(){
        $(".skin").attr("href", base_url+"/css/skins/orange-light/orange-light.css");
        return false;
   	});
   	$(".purple").click(function(){
        $(".skin").attr("href", base_url+"/css/skins/purple/purple.css");
        return false;
   	});
   	$(".brown").click(function(){
        $(".skin").attr("href", base_url+"/css/skins/brown/brown.css");
        return false;
   	});
   	$(".blue").click(function(){
        $(".skin").attr("href", base_url+"/css/skins/blue/blue.css");
        return false;
   	});
 });
